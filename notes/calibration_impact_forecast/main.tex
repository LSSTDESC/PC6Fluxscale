...
At the moment the LSST Operations Simulator (\code{OpSim}) last results (\code{Minion\_1016}) are pessimistic  according to \cite{SN-CADENCE}.
...
\begin{figure*}[t]
\begin{center}
\subfigure[$z = 0.06$]{\includegraphics[width=0.48\linewidth]{lc_sn_z006.pdf}}
\subfigure[$z = 0.87$]{\includegraphics[width=0.48\linewidth]{lc_sn_z087.pdf}}\\
...
\begin{figure*}[t]
\begin{center}
\subfigure[wide]{\includegraphics[width=0.48\linewidth]{sigmas_wide.pdf}}
\subfigure[deep]{\includegraphics[width=0.48\linewidth]{sigmas_deep.pdf}}\\
